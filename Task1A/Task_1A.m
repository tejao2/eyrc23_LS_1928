...
function [A,B] = Jacobian_A_B(Mp,l,g,Ma,Rp,Ra,I_arm,I_pendulum_theta,I_pendulum_alpha)
  ...
  A = [0, 0, 0, 73.43;
       ...
       0, 0, 0, 114.07;
       0, 0, 1, 0];
# A should be (double) datatype 
  B = [107.4;
     0;
     99.91;0];
A = double(A);# B should be (double) datatype
  B = double(B);
endfunction
...
function Rotary_Inverted_Pendulum_main()
  ...
  I_arm = 0.00833;                   # Moment of inertia of the arm in yaw angle i.e. alpha (kgm^2)
  I_pendulum_theta = 0.00375;        # Moment of inertia of the pendulum in tilt angle i.e. theta (kgm^2)
